      ...
      <button
        ...
        className={cn(
          ...
          disabled 
            ...
            : open 
              ? 'border-indigo-500/80 bg-white ring-4 ring-indigo-500/10 text-slate-800'
              : 'border-slate-200 bg-slate-50/40 hover:border-slate-300 hover:bg-slate-50/80 text-slate-800'
        )}
      >
        ...
        <div className="flex items-center gap-1">
          {selectedOption && !disabled && (
            <X
              className="h-4 w-4 text-slate-400 hover:text-slate-600 transition-colors cursor-pointer"
              onClick={handleClear}
            />
          )}
